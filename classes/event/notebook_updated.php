...
/**
 * Event for when a notebook entry is updated.
 *
 ...
 *
 * Class for event to be triggered when a notebook is updated.
 *
 * @package    local_notebook
 * @copyright  2021 Université de Montréal
 * @author     Issam Taboubi <issam.taboubi@umontreal.ca>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class notebook_updated extends \core\event\note_updated {
    ...
    public function get_description() {
        $description = "The user with id '$this->userid' updated the note with id '$this->objectid'";
