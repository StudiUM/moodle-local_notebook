...
/**
 * Strings for component 'local_notebook', language 'en', branch 'MOODLE_310_STABLE'
 *
...
$string['enabled_desc'] = 'Configuration to enable or disable Notebook';
$string['enabledquizattempt'] = 'Enable notebook - Quiz attempts';
$string['enabledquizattempt_desc'] = 'Enable or disable - Notebook - plugin on all quiz attempts';
...
$string['manage'] = 'Notebook settings';
$string['noaccess'] = 'Notebook has either been disabled or you do not have access to this page.';
...
$string['notedeletedmultiple'] = 'The selected notes have been deleted.';
...
$string['noteforuser'] = 'Note {$a->count} of the user {$a->name}';
$string['notenotfound'] = 'The note is not found.';
$string['notereset'] = 'Reset note';
$string['notesave'] = 'Save note';
$string['notesaved'] = 'Your note has been saved.';
$string['notesubject'] = 'Note title';
