    ...
    _createClass(BootstrapTable, [{
      ...
      value: function initPagination() {
        ...
        if (this.paginationParts.includes('pageSize')) {
          ...
          var pageNumber = ["<div class=\"".concat(this.constants.classes.paginationDropdown, "\">\n        <button class=\"").concat(this.constants.buttonsClass, " dropdown-toggle\" type=\"button\" ").concat(this.constants.dataToggle, "=\"dropdown\" aria-label=\"").concat(allSelected ? opts.formatAllRows() : opts.pageSize, " rows per page\"").concat(">\n        <span class=\"page-size\">\n        ").concat(allSelected ? opts.formatAllRows() : opts.pageSize, "\n        </span>\n        ").concat(this.constants.html.dropdownCaret, "\n        </button>\n        ").concat(this.constants.html.pageDropdown[0])];
